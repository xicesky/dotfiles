" Vim color file
" Name:       sky.vim
" Maintainer: Markus Dangl <sky@q1cc.net>
" Homepage:   http://sky.q1cc.net/
"
" Derived from inkpot: http://github.com/ciaranm/inkpot/
...
if has("gui_running")
    if ! g:inkpot_black_background
        hi Normal         gui=NONE   guifg=#cfbfad   guibg=#040404
    else
    ...
    hi StatusLine     gui=BOLD   guifg=#b9b9b9   guibg=#2e2e2e
    hi User1          gui=BOLD   guifg=#00ff8b   guibg=#2e2e2e
    hi User2          gui=BOLD   guifg=#7070a0   guibg=#2e2e2e
    hi StatusLineNC   gui=NONE   guifg=#b9b9b9   guibg=#2e2e2e
    hi VertSplit      gui=NONE   guifg=#b9b9b9   guibg=#2e2e2e

    hi WildMenu       gui=BOLD   guifg=#eeeeee   guibg=#6e6e6e

    hi MBENormal                 guifg=#cfbfad   guibg=#2e2e2e
    hi MBEChanged                guifg=#eeeeee   guibg=#2e2e2e
    hi MBEVisibleNormal          guifg=#cfcfcd   guibg=#4e4e4e
    hi MBEVisibleChanged         guifg=#eeeeee   guibg=#4e4e4e
    ...
    hi Cursor         gui=NONE   guifg=#404040   guibg=#cbcbcb
    hi lCursor        gui=NONE   guifg=#404040   guibg=#cbffcb
    hi CursorIM       gui=NONE   guifg=#404040   guibg=#cbcbff

    hi Folded         gui=NONE   guifg=#cfcfcd   guibg=#4b208f
    hi FoldColumn     gui=NONE   guifg=#8b8bcd   guibg=#2e2e2e

    hi Directory      gui=NONE   guifg=#00ff8b   guibg=NONE
    hi LineNr         gui=NONE   guifg=#9b9b9b   guibg=#181818
    hi NonText        gui=BOLD   guifg=#8b8bcd   guibg=NONE
    hi SpecialKey     gui=BOLD   guifg=#ab60ed   guibg=NONE
    hi Title          gui=BOLD   guifg=#af4f4b   guibg=NONE
    hi Visual         gui=NONE   guifg=#eeeeee   guibg=#4e4e8f

    hi Comment        gui=NONE   guifg=#7bcdff   guibg=NONE
    hi Constant       gui=NONE   guifg=#ffcd7b   guibg=NONE
    hi String         gui=NONE   guifg=#ffcd7b   guibg=#202020
    hi Error          gui=NONE   guifg=#ffffff   guibg=#2e0e0e
    hi Identifier     gui=NONE   guifg=#ff7bff   guibg=NONE
    hi Ignore         gui=NONE
    hi Number         gui=NONE   guifg=#f0ad6d   guibg=NONE
    hi PreProc        gui=NONE   guifg=#409090   guibg=NONE
    hi Special        gui=NONE   guifg=#c080d0   guibg=NONE
    hi SpecialChar    gui=NONE   guifg=#c080d0   guibg=#181818
    ...
    hi perlSpecialMatch   gui=NONE guifg=#c080d0   guibg=#202020
    hi perlSpecialString  gui=NONE guifg=#c080d0   guibg=#202020

    hi cSpecialCharacter  gui=NONE guifg=#c080d0   guibg=#202020
    hi cFormat            gui=NONE guifg=#c080d0   guibg=#202020
